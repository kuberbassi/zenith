...
export const attendanceService = {
  ...
  getSavedIPUResults: () => AttendanceService.getSavedIPUResults(),
  ...
  // Timetable
  getTimetable: (sem) => TimetableService.getTimetable(sem),
  ...
  deleteTimetableSlot: (id, s) => TimetableService.deleteSlot(id, s),

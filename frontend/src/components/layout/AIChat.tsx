            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="fixed bottom-[112px] right-4 lg:right-8 z-50 w-12 h-12 md:w-14 md:h-14 rounded-2xl flex items-center justify-center overflow-hidden group"
                        style={{
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        ref={panelRef}
                        className="fixed bottom-[112px] right-3 lg:right-8 z-50 w-[calc(100vw-24px)] max-w-[380px] h-[520px] max-h-[calc(100vh-128px)] flex flex-col overflow-hidden rounded-2xl"
                        style={{
                            background: '#0c0c0f',
